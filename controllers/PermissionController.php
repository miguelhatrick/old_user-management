...
class PermissionController extends AdminDefaultController
{
	 ...
	 * @var Permission
	 */
	public $modelClass = 'miguelhatrick\modules\UserManagement\models\rbacDB\Permission';

	/**
	 * @var PermissionSearch
	 */
	public $modelSearchClass = 'miguelhatrick\modules\UserManagement\models\rbacDB\search\PermissionSearch';
