...
namespace miguelhatrick\modules\UserManagement\models\search;
...
/**
 * UserVisitLogSearch represents the model behind the search form about `miguelhatrick\modules\UserManagement\models\UserVisitLog`.
 */
